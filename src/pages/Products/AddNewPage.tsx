    ...
    <div className="min-h-screen container mx-auto">
      ...
      >
        ...
        <div className="flex w-full items-end gap-1">
          <PrimaryButton  animationCheck={formLoading} type="submit" buttonPreset="success" className="w-full">
            Submit
          </PrimaryButton>

          
          <PrimaryButton onClick={resetInputs} type="button" buttonPreset="error" className="w-full">
            Reset
          </PrimaryButton>
        </div>
      </form>
